...
// The patched copy generated by build.rs from the pristine vendored
// en_US.dic plus the local fixes in assets/dict/en_US.patches.
const EMBEDDED_DIC: &str = include_str!(concat!(env!("OUT_DIR"), "/en_US.dic"));
